...
/**
 * For demonstrating a function belonging to a separate file
 * @param value The value to print
 */
void fnInHelpers1(int value)
{
  printf("This function is from helpers_1.c\n");
  printf("The value passed from main(): %d\n\n", value);
}
